    ...
    <div className="flex flex-col gap-6">
      <header className="border-b border-border pb-5">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground">
          Configure complete provider directions for new consultations. Every direction remains
          bound to its verified profile revision; ready and active rooms keep their frozen revision.
        </p>
      </header>
