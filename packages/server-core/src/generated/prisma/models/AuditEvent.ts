...
export type AuditEventWhereInput = {
  ...
  aggregateId?: Prisma.UuidFilter<"AuditEvent"> | string
  actorId?: Prisma.UuidNullableFilter<"AuditEvent"> | string | null
  kind?: Prisma.StringFilter<"AuditEvent"> | string
  occurredAt?: Prisma.DateTimeFilter<"AuditEvent"> | Date | string
  details?: Prisma.JsonFilter<"AuditEvent">
...
export type AuditEventScalarWhereWithAggregatesInput = {
  ...
  aggregateId?: Prisma.UuidWithAggregatesFilter<"AuditEvent"> | string
  actorId?: Prisma.UuidNullableWithAggregatesFilter<"AuditEvent"> | string | null
  ...
  details?: Prisma.JsonWithAggregatesFilter<"AuditEvent">
}
...
export type AuditEventOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"sequence" | "id" | "aggregateId" | "actorId" | "kind" | "occurredAt" | "details", ExtArgs["result"]["auditEvent"]>
...
export interface AuditEventDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const auditEventWithSequenceOnly = await prisma.auditEvent.findMany({ select: { sequence: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AuditEvents and only return the `sequence`
   * const auditEventWithSequenceOnly = await prisma.auditEvent.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more AuditEvents and only return the `sequence`
   * const auditEventWithSequenceOnly = await prisma.auditEvent.updateManyAndReturn({
   *   select: { sequence: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AuditEventFieldRefs {
  ...
  readonly aggregateId: Prisma.FieldRef<"AuditEvent", 'String'>
  ...
  readonly details: Prisma.FieldRef<"AuditEvent", 'Json'>
}
